...
class SportQuiz1 extends Component {
    ...
    componentDidMount() {
        const request = new Request('http://127.0.0.1:8080/quiz/sport/1');
        fetch(request)
    ...
    return (
      ...
      {!this.state.submitted && <div>
        <header className="App-header">
          <h1 className="App-title">Sport quiz 1</h1>
        </header>
